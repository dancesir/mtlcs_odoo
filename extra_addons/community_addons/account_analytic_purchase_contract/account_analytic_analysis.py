...
class account_analytic_account(osv.osv):
        ...
        if contract.type == 'purchase_contract':
            ...
            if not journal_ids:
                raise osv.except_osv(_('Error!'),
                                     _('Please define a pruchase journal for the company "%s".') % (
    ...
    def _prepare_invoice_lines(self, cr, uid, contract, fiscal_position_id, context=None):
        ...
        if contract.type == 'purchase_contract':
            ...
            return super(account_analytic_account, self)._prepare_invoice_lines(cr, uid, contract, fiscal_position_id,
                                                                                context=None)
