...
(function(){
    ...
    instance.web_readonly_bypass = {
        ...
        ignore_readonly: function(data, options, mode, context){
            //console.info('## ignore_readonly start',data, options, mode, context);
            ...
            //console.info('## ignore_readonly end', data, options, mode, context);
        ...
        retrieve_readonly_by_pass_fields: function(options, context){
            //console.info('## retrieve_readonly_by_pass_fields start', options,  context);
            ...
            //console.info('## retrieve_readonly_by_pass_fields end', readonly_by_pass_fields);
    ...
    instance.web.BufferedDataSet.include({
        ...
        write : function(id, data, options) {
            //console.info('## BufferedDataSet write start');
            var self = this;
            var context = instance.web.pyeval.eval('contexts', self.context.__eval_context);
            //jon readonly_by_pass from one2many field parent view
            //console.log('>>>>', self.context.__contexts);
            if (self.context.__contexts &&
                    self.context.__contexts.constructor == Array &&
                    /readonly_by_pass/.test(self.context.__contexts[0])){
                var parent_ctx = instance.web.pyeval.eval('contexts', self.context.__contexts);
                context.readonly_by_pass = parent_ctx.readonly_by_pass;
            };
            //jon
