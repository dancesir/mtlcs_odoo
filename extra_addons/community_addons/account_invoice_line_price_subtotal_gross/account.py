...
class AccountInvoiceLine(models.Model):
    ...
    price_subtotal_gross = fields.Float(string='含税总额', digits=dp.get_precision('Account'),
    ...
    def _compute_price_gross(self):
        ...
        if self.invoice_id:
            self.price_subtotal_gross = self.invoice_id.currency_id.round(self.price_subtotal_gross)
